...
public sealed class DotEnvConfigurationProvider(DotEnvConfigurationSource source)
    : FileConfigurationProvider(source)
{
    ...
    public override void Load(Stream stream)
    {
        try
        {
            Data = DotEnvConfigurationFileParser.Parse(stream, _source.ParseOptions);
        }
        catch (DotEnvParseException)
        {
            // Re-throw parsing exceptions as-is to preserve error details
            throw;
        }
        catch (Exception e)
        {
